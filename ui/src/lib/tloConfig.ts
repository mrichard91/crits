...
export interface TLOCreateFieldDef {
  ...
  allowCreate?: boolean // Show "+ Add new..." option in select dropdown
  createMutation?: string // GQL mutation name, e.g. 'createSource'
  createVariables?: Record<string, string> // Extra static vars for the mutation
}
  ...
  RawData: {
    ...
    createFields: [
      { key: 'title', label: 'Title', type: 'text', required: true, placeholder: 'Raw data title' },
      {
        ...
        allowCreate: true,
        createMutation: 'createConfigItem',
        createVariables: { configType: 'RAW_DATA_TYPE' },
      },
      {
        key: 'source',
        label: 'Source',
  ...
  Signature: {
    ...
    createFields: [
      ...
      },
      {
        ...
        allowCreate: true,
        createMutation: 'createConfigItem',
        createVariables: { configType: 'SIGNATURE_TYPE' },
      },
      {
        key: 'source',
        label: 'Source',
